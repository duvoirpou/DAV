...
<div class="table-responsive">
    ...
    <tr>
        ...
        <input type="number" name="avance" id="avance" value="" placeholder="Montant payé" class="form-control"><br>
        <button type="submit" class="btn btn-success">Valider l'achat</button>
      </div>
</form>
<br>
<div class="text-center">
        <button type="button" class="btn btn-danger" id="annuler">Annuler l'achat</button>
      </div>
